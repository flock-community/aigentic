...
fun <I : Any, O : Any> googleHttpCloudFunction(config: HttpCloudFunctionConfig<I, O>.() -> Unit) =
...
private fun <I : Any, O : Any> registerHttpFunction(function: GoogleHttpCloudFunction<I, O>) {
