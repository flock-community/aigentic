...
import community.flock.aigentic.tools.http.EndpointOperation.Method.*
...
class OASParserTest : DescribeSpec({
    ...
    describe("PrimitiveParameter") {
        ...
        it("should parse integer path params") {
            ...
            operation shouldBe EndpointOperation(
                name = "getItemById", description = "Get an item by its ID", method = GET, pathParams = listOf(
                    Parameter.Primitive(
                        name = "itemId",
    ...
    describe("ArrayParameter") {
        ...
        describe("should parse request body which has a array property which is of type object") {
            ...
            operations.first() shouldBe EndpointOperation(
                name = "POST /users",
                ...
                requestBody = Parameter.Complex.Object(
                    name = "body", description = "User to be created", isRequired = true, parameters = listOf(
                        Parameter.Primitive(
                            name = "username",
                            description = null,
                            isRequired = true,
                            ...
                            itemDefinition = Parameter.Complex.Object(
                                "item", description = null, true, parameters = listOf(
                                    Parameter.Primitive(
                                        name = "street",
                                        description = null,
                                        isRequired = true,
        ...
        it("should parse request body which has a array property which is of type array") {
            ...
            operations.first() shouldBe EndpointOperation(
                ...
                queryParams = emptyList(),
                requestBody = Parameter.Complex.Object(
                    name = "body", description = "Project to be created", isRequired = true, parameters = listOf(
                        Parameter.Primitive(
                            name = "projectName",
                            description = null,
                            isRequired = true,
                            ...
                            description = null,
                            isRequired = true,
                            itemDefinition = Parameter.Complex.Array(
                                "item", description = null, false, itemDefinition = Parameter.Complex.Object(
                                    name = "item", description = null, isRequired = false, parameters = listOf(
                                        Parameter.Primitive(
                                            name = "name",
                                            description = null,
                                            isRequired = false,
                ...
                requestBody = Parameter.Complex.Object(
                    ...
                    parameters = listOf(
                        Parameter.Primitive(
                            ...
                            description = null,
                            isRequired = true,
                            itemDefinition = Parameter.Complex.Enum(
                                name = "item", description = null, isRequired = true, default = null, values = listOf(
    ...
    describe("ObjectParameter") {
        ...
        it("should map object request body params") {
            ...
            operation shouldBe EndpointOperation(
                ...
                queryParams = emptyList(),
                requestBody = Parameter.Complex.Object(
                    name = "body", description = "Item to be created", parameters = listOf(
                        Parameter.Primitive(
    ...
    context("should parse all operations") {
        withData(
            "/petstore.json" to 19, "/github.json" to 930, "/hackernews.json" to 7
