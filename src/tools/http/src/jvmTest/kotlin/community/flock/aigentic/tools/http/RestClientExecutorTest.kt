...
class RestClientExecutorTest : DescribeSpec({
    ...
    describe("happy path") {
        ...
        it("should execute operation with callArguments") {
            ...
            val operation = EndpointOperation(
                name = "getItemsByCategory",
                description = null,
                method = EndpointOperation.Method.GET,
                pathParams = listOf(
                    Parameter.Primitive(
                        name = "id", description = "Item id", isRequired = true, type = ParameterType.Primitive.Integer
                    )
                ),
            ...
            val callArguments = buildJsonObject {
                put("id", 2)
            ...
            val restClient = mockk<RestClient>().apply {
                coEvery {
                    execute(
