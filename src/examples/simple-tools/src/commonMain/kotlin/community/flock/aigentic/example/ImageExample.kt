...
suspend fun runItemCategorizeExample(apiKey: String, base64Image: String) {
...
//            addImageUrl("https://fastly.picsum.photos/id/26/4209/2769.jpg?hmac=vcInmowFvPCyKGtV7Vfh7zWcA_Z0kStrPDW3ppP0iGI", MimeType.JPEG)
        }
    }.start()
}
