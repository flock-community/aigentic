...
function Footer() {
  ...
  return (
    <>
      {!isDocsPage && (
        <section className="start-aigentic">
                ...
                <div className="card card-border-bottom card-footer">
                  <div className="card-footer-header">
                    <Heading as="h2" className={clsx(styles.heading2)}>
                      Start with <span>Aigentic</span>
                    </Heading>
                    <p>
                      Streamline your LLM development journey with a powerful Kotlin DSL for building
                      and integrating AI agents into applications. Choose the right tools for your
                      specific needs.
                    </p>
                  </div>
