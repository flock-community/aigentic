...
const config: Config = {
    title: "Aigentic",
    tagline: "Build powerful AI agents with Kotlin",
    favicon: "img/aigentic-favicon.png",
    url: "https://aigentic.io/",
    baseUrl: "/",
    organizationName: 'flock-community/aigentic',
