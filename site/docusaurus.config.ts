...
const config: Config = {
  ...
  themeConfig: {
    ...
    image: "img/aigentic-logo-fixed.svg",
    navbar: {
      title: "",
      logo: {
        alt: "Aigentic Logo",
        src: "img/aigentic-logo-fixed.svg",
      },
      items: [
        {
          to: "/vision",
      ...
      links: [
        {
          items: [
            ...
            {
              label: "Initializr",
              to: "https://github.com/flock-community/aigentic-initializr",
            },
          ],
        },
        {
