...
```kotlin
// With attachments
val pdfAttachment = Attachment.pdf("base64-encoded-pdf-content")
val imageAttachment = Attachment.jpeg("base64-encoded-image-content")
...
suspend fun processLegalDocument(apiKey: String) {
    ...
    val workflowRun = workflow.start(documentText, Attachment.pdf("base64-encoded-pdf-content"))
