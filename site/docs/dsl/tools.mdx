...
The `description` property in `@AigenticParameter` significantly improves LLM interactions. This description is included in the tool schemas sent to the LLM, giving it context about:
- The overall purpose of the parameter object
- How this object fits into the tool's functionality
- Any special considerations for using this parameter type

Good descriptions help the LLM better understand when and how to use your tools, resulting in improved agent performance.
...
#### Importance of Property Descriptions

Property descriptions greatly enhance LLM interactions. Each property description is included in the tool schemas sent to the LLM, providing details about:
- The specific purpose of each property
- Expected formats and valid values
- Relationships between properties
- Examples of proper usage (when included in the description)

Clear property descriptions help the LLM create more accurate parameter objects, reducing errors and making your tools work better. Adding more context through descriptions helps the LLM understand how to use your tools properly.
